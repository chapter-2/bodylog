<template>
  <div class="min-h-screen bg-background">
    <section class="inner py-20 md:py-32 text-center relative overflow-hidden">
      ...
      >
        Aplikasi tracker minimalis untuk eksekusi yang serius. Catat target
        beban latihanmu, pantau perkembangan berat badan, dan diskusikan
        progresmu dengan AI Coach. Sepenuhnya privat.
      </p>
        ...
        <div class="p-8 md:p-10 group hover:bg-[#fcfbf7] transition-colors">
          <div class="flex items-start gap-5">
            ...
            <div>
              ...
              >
                Manajemen jadwal terpusat dengan pelacakan progressive overload
                bawaan. Setiap sesi otomatis menampilkan riwayat minggu
                sebelumnya sebagai acuan beban.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="flex items-start gap-5">
            ...
            <div>
              ...
              <p
                class="font-mono text-sm text-foreground-text leading-relaxed opacity-80"
              >
                Pelacakan repetisi dan durasi tahanan secara presisi, pengaturan
                substitusi alat, serta milestone tracker khusus untuk Bodyweight
                Skills.
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start gap-5">
            ...
            <div>
              ...
              <p
                class="font-mono text-sm text-foreground-text leading-relaxed opacity-80"
              >
                Pencatatan berat badan mingguan dengan strategi dinamis.
                Sesuaikan dengan fase targetmu (Bulk, Cut, atau Maintain).
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="flex items-start gap-5">
            ...
            <div>
              ...
              <p
                class="font-mono text-sm text-foreground-text leading-relaxed opacity-80"
              >
                Ekspor seluruh data ke format CSV terstruktur. Termasuk
                instruksi prompt otomatis agar AI dapat membaca konteks dan
                progres harianmu.
              </p>
            </div>
          </div>
    ...
    >
      <div class="text-center max-w-3xl mx-auto px-6">
        ...
        >
          Kami sama sekali tidak memiliki akses ke data latihanmu. Tidak ada
          pelacakan tersembunyi ataupun sinkronisasi data ke pihak ketiga.
          Seluruh catatan progresmu murni milikmu dan tersimpan dengan aman
          secara mandiri.
        </p>
      </div>
    </section>
    ...
    >
      <span class="font-handwriting text-xl text-primary block mb-2 -rotate-1"
