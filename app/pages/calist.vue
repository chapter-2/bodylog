    ...
    <div class="min-h-screen bg-white">
            ...
            <div class="inner border-x border-separator bg-white p-8 md:p-16">
                <div class="space-y-6">
                    <div
                        v-for="i in 4"
                        :key="i"
                        class="border-2 border-separator p-6"
                    >
                        <div
                            class="h-6 w-2/3 bg-separator mb-4 animate-pulse"
                        ></div>
        ...
        <div v-else>
            ...
            >
                ...
                >
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-bold text-yellow-900 text-sm">
                                PREVIEW MODE
                            </p>
            ...
            >
                ...
                >
                <h1
                    class="text-5xl md:text-7xl font-black uppercase text-foreground-primary mb-4"
                >
                    Calist Log
                </h1>
                <p
                ...
                >
                    ...
                    <span class="font-mono text-sm text-primary font-bold"
                        >Today: {{ todayDayName }} • Week
                        {{ calculatedWeek }}</span
                    >
                </div>

                <div
                    class="flex flex-wrap justify-center gap-2 max-w-2xl mx-auto px-4"
                >
                    <button
                        v-for="d in ALL_DAYS"
                        :key="d.value"
                    ...
                    >
                        ...
                        <span
                            v-if="
                                isRestDay(d.value) && !isDayCompleted(d.value)
                            "
                ...
                <div class="p-8 md:p-12">
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                class="hidden md:block md:col-span-3 text-right"
                            >
                                Status
                            </div>
                        </div>
                    ...
                    >
                        ...
                        />
                        <p
                            class="font-mono text-sm text-foreground-text opacity-60 mb-4"
                        >
                            {{
                                isAuthenticated
...
function getDayName(dayValue: string) {
    if (globalConfig.value[dayValue]?.name)
        return globalConfig.value[dayValue].name;
    const defaults: any = {
        monday: "FULL BODY A",
        tuesday: "FULL BODY B",
